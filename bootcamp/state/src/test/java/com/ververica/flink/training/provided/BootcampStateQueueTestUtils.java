...
public class BootcampStateQueueTestUtils {
    ...
    public static void testQueueSingleEntryUtil(
            BiFunction<String, Class<?>, BootcampStateQueue> queueFactory) throws Exception {
    ...
    public static void testQueueAsBatcherUtil(
            BiFunction<String, Class<?>, BootcampStateQueue> queueFactory) throws Exception {
    ...
    private static class TestBatchFunction extends RichFlatMapFunction<Tuple2<String, Long>, Long> {
        ...
        public TestBatchFunction(
                BiFunction<String, Class<?>, BootcampStateQueue> queueFactory, int batchSize) {
            this.queueFactory = queueFactory;
