...
During the training, participants will be asked to run the Flink job `xx` locally.
### Running Locally

Executing `com.ververica.flink.training.exercises.XXX#main()` should create a local Flink cluster
