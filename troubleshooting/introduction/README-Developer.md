...
running the troubled streaming job.

If this is the first time you've run the `main()` method, it's likely your job will fail with an error message about:

`Caused by: java.lang.reflect.InaccessibleObjectException: Unable to make field private final java.lang.Object[] java`

To fix this, edit your run configuration to add these VM arguments:
...
When the job is running, Flink's Web UI will be available at http://localhost:8081.
